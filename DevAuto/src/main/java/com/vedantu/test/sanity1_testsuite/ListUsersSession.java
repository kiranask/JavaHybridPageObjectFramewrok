...
public void ListUserSchedule() throws InterruptedException 
	...
	{	
		...
		String Sheet = "Sheet7";
		//String adminName = Excel.getCellValue(xlPath, Sheet, 1, 1);
		String adminName ="test.automation@vedantu.com";
		//String adminPassword = Excel.getCellValue(xlPath, Sheet, 2, 1);
		String adminPassword = "vedantu123";
		
		LoginPage loginpage = new LoginPage(driver);
		loginpage.loginClick();
		loginpage.loginCredentials(adminName,adminPassword);
		loginpage.logClick();
		...
		Thread.sleep(1000);
		driver.findElement(By.xpath("//input[@ng-keyup='onQuerySubmit($event)']")).sendKeys("test.automation.student@gmail.com");
		Thread.sleep(2000);
		...
		driver.findElement(By.xpath("html/body/div[1]/div[3]/div/div[2]/input[1]")).sendKeys("test.automation.teacher@gmail.com");
		Thread.sleep(1000);
